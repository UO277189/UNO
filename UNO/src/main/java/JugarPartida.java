...
import main.java.manejoDatos.manejoConsola.ConfigurarPartidaConsola;
...
import main.java.manejoDatos.manejoFicheros.ManejoFicherosTXT;
...
public class JugarPartida {
	...
	private static void introducirDatosManuales() {
		...
		ConfigurarPartidaConsola leerDatosManual = new ConfigurarPartidaConsola(leerConsola);

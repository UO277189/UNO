...
public abstract class Jugador {
	 ...
	 * @param cartasMano ArrayList
	 */
	public Jugador(String nombreJugador, ArrayList<Carta> cartasMano) {
	 ...
	 */
	public void aumentarDatosJugador(Jugador jugadorAbstract) {
